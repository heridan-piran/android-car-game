...
public class Camera {
	...
	public Camera(double px, double py, double w, double h, double padx,
			double pady) {
		x = px;
		y = py;
		viewwidth = w;
	...
	public Camera(Unit lockedun, double w, double h, int offx, int offy,
	...
	public boolean getIsLockedOnUnit() {
		return lockedonunit;
	}

	public Unit getLockedUnit() {
		return lockedunit;
	}
